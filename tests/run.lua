...
assertEqual(Core.VERSION, "0.2.0", "core exposes current version")
...
assertTruthy(toc:find("## Version: 0.2.0", 1, true), "toc version present")
...
assertTruthy(runtime:find("frame:SetScript(\"OnHide\", function()", 1, true), "settings window uses a close handler")
assertTruthy(runtime:find("HideFontPicker()", 1, true), "settings window closes the custom font picker")
assertTruthy(runtime:find("CancelSettingsPreview()", 1, true), "settings window restores previews on close")
