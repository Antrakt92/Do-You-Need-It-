...
assertTruthy(runtime:find("local WINDOW_HEIGHT = 330", 1, true), "runtime uses compact non-overlapping window height")
assertTruthy(runtime:find("local ROW_START_Y = -116", 1, true), "runtime leaves a separate header area above rows")
...
assertTruthy(runtime:find("layout=540x330", 1, true), "runtime reports compact layout in status")
